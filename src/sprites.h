...
extern SDL_Texture* g_multBorder[6];
extern SDL_Texture* g_multSymbol[6];
constexpr int BAR_STEPS = 11;
extern Sprite g_barRight[BAR_STEPS];
extern Sprite g_barLeft[BAR_STEPS];
